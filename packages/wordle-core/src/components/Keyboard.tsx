...
import { loadKeyboard, loadKeyboardActions, getNormalization } from '../languageLoader';
...
interface KeyboardProps {
  ...
  language: string;
  /** evaluation = Wordle colors; used-unused = Hydra (no green/yellow/gray). */
  colorMode?: 'evaluation' | 'used-unused';
}
...
export const Keyboard: React.FC<KeyboardProps> = ({
  ...
  const getKeyClass = (key: string): string => {
    ...
    if (colorMode === 'used-unused') {
      return letterStates.has(canonicalKey) ? 'key used' : 'key';
    }
